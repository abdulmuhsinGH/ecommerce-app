...
func TestUpdateUser(t *testing.T) {
	...
	userUpdatedInfo, err := userRepositoryTest.UpdateUser(&u)
	if err != nil {
		t.Errorf("Test Failed; Users added. User not updated")
	}

	if userUpdatedInfo.Firstname != "New Name" {
		t.Fatalf("Test Failed; Number of user expected firstname %v; actual %v", "New Name", userUpdatedInfo.Firstname)
	}
